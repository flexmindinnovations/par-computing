...
// Solution data from the old website
const solutionsData = [
  {
    ...
    relatedSolutions: ["unified-communication-solutions", "internet-security-hosting", "cloud-solutions"]
  },
  {
    ...
    relatedSolutions: ["networking-solutions", "cloud-solutions"]
  },
  {
    id: "cloud-solutions",
    ...
    relatedSolutions: ["storage-backup-solutions", "internet-security-hosting"]
  },
  {
    ...
    relatedSolutions: ["networking-solutions", "cloud-solutions", "storage-backup-solutions"]
  },
  {
    ...
    relatedSolutions: ["cloud-solutions", "internet-security-hosting"]
  }
];
...
export default function SolutionDetailPage() {
  ...
  }, [solution, solutionId, navigate]);
  
  if (!solution) {
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <p className="text-lg">Loading solution details...</p>
      </div>
    );
  }
    // Get related solutions
  const relatedSolutionsList = solution.relatedSolutions.map(id => 
    solutionsData.find(s => s.id === id)
  ).filter(Boolean);
      ...
      >
        ...
        >
          <div className="aspect-video w-full bg-gradient-to-r from-[var(--primary-color)] to-[var(--accent-color)] rounded-lg flex items-center justify-center">
            ...
            <span className="text-white text-lg font-semibold">Solution Image</span>
          </div>
        </motion.div>
      </motion.section>
          ...
          >
            <div className="w-full h-full flex items-center justify-center p-6">
              <div className="text-center text-[var(--primary-color)]">
                <h3 className="text-2xl font-bold mb-4">Why Choose Our {solution.title}</h3>
        ...
        >
          <div className="container mx-auto px-4">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              {relatedSolutionsList.map((relatedSolution) => relatedSolution && (                <motion.div 
                  key={relatedSolution.id}
                  className="theme-card rounded-lg overflow-hidden hover:shadow-xl transition-all"
                  variants={itemVariants}
                  whileHover={{ y: -10 }}
                  onClick={() => navigate(`/solutions/${relatedSolution.id}`)}
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="w-12 h-12 rounded-full mb-4 flex items-center justify-center" style={{ background: 'var(--primary-color)', color: 'white' }}>
                      {relatedSolution.icon}
                    </div>
                    <h3 className="text-xl font-bold mb-3">{relatedSolution.title}</h3>
                    <p className="opacity-80 mb-6">{relatedSolution.shortDescription}</p>
      ...
      >
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <motion.p 
            ...
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            Get in touch with our team of experts to discuss how our {solution.title} can benefit your business.
          </motion.p>
